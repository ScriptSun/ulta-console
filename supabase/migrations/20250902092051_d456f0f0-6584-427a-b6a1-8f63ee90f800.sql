-- Update the system prompt with the proper router prompt that includes JSON instructions
...
SET setting_value = jsonb_build_object(
  ...
  'author', 'system',
  'created_at', now(),
  'content', 'You are UltaAI, a conversational hosting assistant that responds in JSON format.
