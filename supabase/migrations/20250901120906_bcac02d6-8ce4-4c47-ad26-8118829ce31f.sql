-- Remove duplicate entries and add missing tab permissions (fixed roles)
...
-- Add role template permissions using existing valid roles
INSERT INTO console_role_templates (role, page_key, can_view, can_edit, can_delete) VALUES 
-- Owner permissions (assuming 'Owner' exists)
