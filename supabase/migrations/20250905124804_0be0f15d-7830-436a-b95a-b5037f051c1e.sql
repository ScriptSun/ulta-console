-- Fix the notification policies table by making created_by nullable for system defaults
ALTER TABLE public.notification_policies ALTER COLUMN created_by DROP NOT NULL;
ALTER TABLE public.notification_policies ALTER COLUMN updated_by DROP NOT NULL;
