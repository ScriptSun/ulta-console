-- Insert 3 demo agents for testing purposes with proper UUIDs
...
('22222222-2222-2222-2222-222222222222', 'warning', 'High memory usage detected', '{"memory_usage": 85.2, "threshold": 80}', now() - interval '20 minutes'),
