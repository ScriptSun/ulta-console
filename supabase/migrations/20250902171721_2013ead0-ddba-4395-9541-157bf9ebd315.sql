...
SET content_base64 = encode(convert_to('You are UltaAI, a conversational hosting assistant.
...
- For chat, text only. For actions, JSON only.', 'UTF8'), 'base64'),
    updated_at = now(),
    updated_by = '00000000-0000-0000-0000-000000000000'
WHERE prompt_key = 'router';